...
init_mag[-1] = 0.1
atoms.set_initial_magnetic_moments(magmoms=init_mag) #perturbs the magnetic moment of the system, this is required in spinpolarized systems but should not be done in spin p
aired systems
